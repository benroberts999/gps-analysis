...
# Ubuntu:
set margin 7,2,3,3
set ylabel '$\log_{10}|d_{\mathrm{eff}}|$' offset -0.5
...
# set label '(this work)' tc rgb 'white' at 3e-17,8e0 front
set label '\small{Lab Clocks (projection)}' tc rgb 'dark-orange' at 1.2e-17,1.0e-1
set label '\small{Space Clocks (projection)}' tc rgb 'dark-green' at 1.2e-17,2.0e-4
...
plot \
  "../existing/MICROSCOPE.txt" w l dt tdt lc "gray" lw 0.5 notitle\
  ,"../existing/MICROSCOPE.txt" w filledcurves x2 fillstyle transparent solid 0.1 lc "gray" notitle\
  ,"../existing/YbCs.txt" w l dt tdt lc "dark-blue" notitle\
  ,"../existing/YbCs.txt" w filledcurves x2 lc "dark-blue" notitle\
  ,"../existing/HSi.txt" w l dt tdt lc "blue" notitle\
  ,"../existing/HSi.txt" w filledcurves x2 lc "blue" notitle\
  ,"../existing/HQuartzSapphire.txt" u 1:($2*3.0) w l dt tdt lc "royalblue" notitle\
  ,"../existing/HQuartzSapphire.txt" u 1:($2*3.0) w filledcurves x2 lc "royalblue" notitle\
  ,"../existing/RbQuartz.txt" w l dt tdt lc "web-blue" notitle\
  ,"../existing/RbQuartz.txt" w filledcurves x2 lc "web-blue" notitle\
